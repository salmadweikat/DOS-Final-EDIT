...
public class FrontEndServer {
	...
	->{ String id =request.params(":id");
	    InputStream data = CheckCacheUsingID(id, "lookup");
	       if(data == null)
	       {
	    	   System.out.println("This data not available in cache .");
	       } 
   ...
   return datain;
	...
	static String RoundRobin(String hint)
	{
		...
		IPsL.add("http://192.168.1.117:7766/Lookup/");//clone2
		
		ArrayList<String> IPsS =new ArrayList<String>();
		IPsS.add("http://192.168.1.124:8000/Search/");
		IPsS.add("http://192.168.1.117:8022/Search/");//clone2
		
		
		ArrayList<String> IPsB =new ArrayList<String>();
		IPsB.add("http://192.168.1.123:7000/Buy/");
		IPsB.add("http://192.168.1.118:7022/Buy/");//clone3
	...
	public static void SendInvalidate(String ID)
	{
		...
		if(index==-1)
		{
			System.out.println("Cache doeesn't have this data");
		}
		else
		{
			Mem.remove(index);
